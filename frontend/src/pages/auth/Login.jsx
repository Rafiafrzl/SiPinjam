...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex relative bg-white overflow-hidden">
      ...
      <div className="w-full lg:w-[45%] flex flex-col min-h-screen bg-white relative">
        {/* Mobile Header - Fixed at top */}
        <div className="lg:hidden py-3 px-4 flex items-center  border-b border-gray-100">
          <div
          ...
          <div>
            <h1 className="font-bold text-gray-900 text-lg">SiPinjam</h1>
            <p className="text-gray-500 text-xs">Sistem Peminjaman Barang</p>
          </div>
        </div>
